    ...
    <div class="card o-hidden border-0 bg-light">
        <div class="card-block">
            <div class="card-text text-center">
                ...
                <form method="post" action="<?= base_url() ?>/submitedit/penelitian/<?= $dt['id'] ?>" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                                ...
                                <div class="form-row align-items-right mt-3">
                                    <div class="col-12">
                                        <div class="input-group-prepend">            
                                            ...
                                            <textarea class="form-control" name="judulPenelitian" id="judulPenelitian" rows="4"><?= $dt['judul'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="bidangFokus" id="bidangFokus" onfocusin="yellowin(this);" onfocusout="whiteout(this)">                                                
                                                <option value="Kesehatan" <?= $dt['bidang_fokus']=="Kesehatan" ? "selected":"" ?>>Kesehatan</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="kelompokSkema" id="kelompokSkema" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                                <option value="Riset Dasar" <?= $dt['skema']=="Riset Dasar" ? "selected":"" ?>>Riset Dasar</option>
                                                <option value="Riset Terapan" <?= $dt['skema']=="Riset Terapan" ? "selected":"" ?>>Riset Terapan</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="ruangLingkup" id="ruangLingkup" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                                <option value="Penelitian Dosen Pemula" <?= $dt['ruang_lingkup']=="Penelitian Dosen Pemula" ? "selected":"" ?>>Penelitian Dosen Pemula</option>
                                                <option value="Penelitian Terapan - Penelitian Produk Vokasi" <?= $dt['ruang_lingkup']=="Penelitian Terapan - Penelitian Produk Vokasi" ? "selected":"" ?>>Penelitian Terapan - Penelitian Produk Vokasi</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row align-items-right mt-3">
                                    <div class="col-12">
                                        <div class="input-group-prepend">            
                                            ...
                                            <textarea class="form-control" name="temaPenelitian" id="temaPenelitian" rows="4"><?=$dt['tema']?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row align-items-right mt-3">
                                    <div class="col-12">
                                        <div class="input-group-prepend">            
                                            ...
                                            <textarea class="form-control" name="topikPenelitian" id="topikPenelitian" rows="4"><?=$dt['topik']?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row align-items-right mt-3">
                                    <div class="col-6">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="rumpunIlmu" id="rumpunIlmu" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                                <option value="Ilmu Keperawatan" <?=$dt['rumpun_ilmu']=="Ilmu Keperawatan" ? "selected" : ""?>>Ilmu Keperawatan</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class=" form-row align-items-right mt-3">
                                    <div class="col-4">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="text" name="targetTKT" id="targetTKT" class="form-control" placeholder="Masukkan Target TKT ....." onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return placeDateOnly(event);" value="<?= $dt['target_tkt']?>">
                                        </div>
                                    </div>
                                </div>
