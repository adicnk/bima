    ...
    <div class="card o-hidden border-0 bg-light">
        <div class="card-block">
            <div class="card-text text-center">
                ...
                <form method="post" action="<?= base_url() ?>/submit/pengabdian" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                                ...
                                <div class="form-row align-items-right mt-3">
                                    <div class="col-12">
                                        <div class="input-group-prepend">            
                                            ...
                                            <textarea class="form-control" name="judulPengabdian" id="judulPengabdian" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-8">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="kelompokSkema" id="kelompokSkema" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                                <option value="Pemberdayaan Berbasis Masyarakat">Pemberdayaan Berbasis Masyarakat</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control" name="ruangLingkup" id="ruangLingkup" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                                <option value="Pengabdian Masyarakat Pemula">Pengabdian Masyarakat Pemula</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
