<?= $this->extend('template/dshboard-user') ?>
        ...
        <table class="table table-striped">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col" width="300px">Judul</th>

                    <th scope="col" width="150px">Bidang Fokus</th>

                    <th scope="col" width="300px" style="text-align: center">Tahun Pelaksanaan</th>

                    <th scope="col" width="50px" style="text-align: center">Peran</th>

                    <th scope="col" width="50px" style="text-align: center">Status Usulan</th>

                    <th scope="col" width="50px" style="text-align: center">Aksi</th>
